...
*constant/(neutronicsRegionName)/*. One can find examples of three different quadrature 
sets in the tutorial `Godiva_SN
...
Here follows the list of entries to set the *quadratureSet* dictionnary:
