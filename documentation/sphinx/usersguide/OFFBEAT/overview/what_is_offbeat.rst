...
performance code designed for the thermo-mechanical analysis of nuclear
fuel and cladding, both under reactor operating conditions and in
...
description of fuel and cladding behaviour, where nuclear-specific
phenomena are represented through dedicated material and phenomenological
models. The code is intended for both steady-state and transient analyses,
...
- analysis of hydrogen behaviour in cladding, with or without liner.
...
relocation, creep, plasticity, and thermal expansion, as well as
...
mechanical contact, while OpenFOAM mapping algorithms are used to transfer
fields across the gap, also in the presence of non-conformal interfaces.
