...
solver derived from OFFBEAT [:ref:`SCOLARO2020110416 <SCOLARO2020110416>`]. The former will be presented
here, whereas the latter is described in details in the
`OFFBEAT Documentation <https://foam-for-nuclear.gitlab.io/offbeat/>`_.

.. note ::

    What in OFFBEAT is named *solverDict*, in GeN-Foam has been renamed
    *thermomechanicalProperties*, for continuity between the two mechanics
    solvers.
...
properties of structures, subdivided according to the cellZones of the
...
traction on a boundary. Work is ongoing to adapt to GeN-Foam the contact
boundary condition of the OFFBEAT fuel behavior solver
