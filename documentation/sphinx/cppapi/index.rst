...
.. list-table::
    ...
    * - :doc:`generated/porousMediaModels/physicsModels/dragModels/FFDragCoefficientModels/Autruffe/AutruffeFFDragCoefficient`
      - Autruffe correlation for the fluid–fluid friction factor, originally developed
    ...
    * - :doc:`generated/porousMediaModels/physicsModels/dragModels/FFDragCoefficientModels/NoKazimi/NoKazimiFFDragCoefficient`
      - NoKazimi fluid–fluid drag coefficient model for liquid–gas systems
    ...
    * - :doc:`generated/porousMediaModels/physicsModels/dragModels/FFDragCoefficientModels/BestionTRACE/BestionTRACEFFDragCoefficient`
      - BestionTRACE fluid–fluid drag coefficient model (TRACE-style variant) for
    * - :doc:`generated/porousMediaModels/physicsModels/dragModels/FFDragCoefficientModels/Bestion/BestionFFDragCoefficient`
      - Bestion fluid–fluid drag coefficient model for liquid–gas systems
    ...
    * - :doc:`generated/porousMediaModels/physicsModels/dragModels/FSDragCoefficientModels/Colebrook/ColebrookFSDragCoefficient`
      - Drag coefficient in the form :math:`f_d = ( A \log_{10}(Re) + B )^C`
    ...
    * - :doc:`generated/porousMediaModels/physicsModels/dragModels/FSDragCoefficientModels/ReynoldsPower/ReynoldsPowerFSDragCoefficient`
      - Drag coefficient in the form :math:`f_d = A + B \times Re^C`
...
.. toctree::
   ...
   generated/classes/offbeat/src/offbeatLib/materials/materialModel/behavioralModels/failureModels/ZyOverstrainRIA
   generated/classes/offbeat/src/offbeatLib/materials/materialModel/thermoMechanicalPropertiesModels/conductivity/conductivityUPuO2Magni2020
...
.. list-table::
    ...
    * - :doc:`generated/classes/offbeat/src/offbeatLib/materials/materialModel/behavioralModels/failureModels/ZyOverstrainRIA`
      - Overstrain criterion to asses clad failure during the PCMI phase of a RIA transient
    * - :doc:`generated/classes/offbeat/src/offbeatLib/materials/materialModel/thermoMechanicalPropertiesModels/conductivity/conductivityUPuO2Magni2020`
      - Model for thermal conductivity of high-Pu content MOX
...
.. list-table::
    ...
    * - :doc:`generated/functionObjects/massFlow/massFlow`
      - Calculates the total mass flux in kg/s through a set of faceSets, faceZones
...
.. toctree::
   ...
   generated/offbeat/src/offbeatLib/fvPatchFields/tractionDisplacement/gapContactFvPatchVectorField
   ...
   
...
.. list-table::
    ...
    * - :doc:`generated/offbeat/src/offbeatLib/fvPatchFields/tractionDisplacement/gapContactFvPatchVectorField`
      - The `gapContact` boundary condition uses the penalty method to handle 
    ...
    * - :doc:`generated/classes/offbeat/src/offbeatLib/fvPatchFields/fixedDisplacement/plenumSpringFixedDisplacementFvPatchVectorField`
      - Plenum spring patchfield for the top of the fuel column or for the topCap
    * - :doc:`generated/classes/offbeat/src/offbeatLib/fvPatchFields/fixedDisplacement/topCladRingFixedDisplacementFvPatchVectorField`
      - Patchfield for the top cladding ring, to be used when the top cap is not 
    * - :doc:`generated/classes/offbeat/src/offbeatLib/fvPatchFields/fixedDisplacement/coolantPressureFixedDisplacementFvPatchVectorField`
      - Coolant pressure patch-field of fixed-displacement type
    * - :doc:`generated/classes/offbeat/src/offbeatLib/fvPatchFields/fixedDisplacementZeroShear/plenumSpringFixedDisplacementZeroShearFvPatchVectorField`
      - Plenum spring patchfield for the top of the fuel column (fixedDisplacement-
    * - :doc:`generated/classes/offbeat/src/offbeatLib/fvPatchFields/fixedDisplacementZeroShear/topCladRingFixedDisplacementZeroShearFvPatchVectorField`
      - Patchfield for the top cladding ring, to be used when the top cap is not 
    * - :doc:`generated/classes/offbeat/src/offbeatLib/fvPatchFields/fixedDisplacementZeroShear/coolantPressureFixedDisplacementZeroShearFvPatchVectorField`
      - Coolant pressure patch-field of fixed-displacement-zeroShear type
    * - :doc:`generated/classes/offbeat/src/offbeatLib/fvPatchFields/mappedFromTH/mappedFromTHFvPatchScalarField`
      - This boundary condition maps the value at a set of cells or patch faces
    * - :doc:`generated/classes/offbeat/src/offbeatLib/fvPatchFields/mixedMappedOF/mixedMappedOFFvPatchScalarField`
      - This boundary condition maps the value at a set of cells or patch faces
