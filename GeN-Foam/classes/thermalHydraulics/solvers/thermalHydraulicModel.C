...
namespace Foam
{
    defineTypeNameAndDebug(thermalHydraulicModel, 0);
...
Foam::thermalHydraulicModel::thermalHydraulicModel
(
    Time& time,
    fvMesh& mesh,
...
void Foam::thermalHydraulicModel::stop()
{
...
void Foam::thermalHydraulicModel::adjustTimeStep()
{
    this->correctCourant();
