...
{
    defineTypeNameAndDebug(timeDependentPower, 0);
...
Foam::powerModels::timeDependentPower::timeDependentPower
(
...
:
    ...
    timeDependentPowerPtr_(nullptr),
    T_
    (
        IOobject
        (
    ...
    )
{
    ...
    forAll(this->toc(), regioni)
    {
        ...
        else
        {
            FatalErrorInFunction
                << "timeDependentPower region: " << region << " -> "
    ...
    //- Check if time dependent power provided
    word decayPowerDictName("timeDependentPowerTimeProfile");
...
void Foam::powerModels::timeDependentPower::correctT(volScalarField& T) const
{
    forAll(cellList_, i)
    {
...
void Foam::powerModels::timeDependentPower::powerOff()
{
    powerDensity_ *= 0.0;
}


void Foam::powerModels::timeDependentPower::correct
(
...
)
{
    ...
    over the cells over which the timeDependentPower models exists. The time
