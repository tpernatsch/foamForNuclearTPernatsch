...
)
{
    ...
    FSHeatTransferCoefficientModelsConstructorTable::iterator cstrIter =
        FSHeatTransferCoefficientModelsConstructorTablePtr_->find(type);

    if (cstrIter == FSHeatTransferCoefficientModelsConstructorTablePtr_->end())
    {
