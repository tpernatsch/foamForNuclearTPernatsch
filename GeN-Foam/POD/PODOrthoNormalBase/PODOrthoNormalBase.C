...
PODOrthoNormalBase::PODOrthoNormalBase
(
    const PtrListVolField& snapshots,
...
Foam::PODOrthoNormalBase::~PODOrthoNormalBase()
{
...
void Foam::PODOrthoNormalBase::calcOrthoBase
(
    const PtrListVolField& snapshots,
    const scalar accuracy
)
{
	...
	//scalar magSumSquare = Foam::sqrt(Foam::gSumSqr(onBase));//////////////////////////////////////////
	scalar magSumSquare = Foam::sqrt(fvc::domainIntegrate(onBase*onBase).value());
