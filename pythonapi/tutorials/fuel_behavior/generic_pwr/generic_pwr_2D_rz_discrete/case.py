...
pellet_count     = 3
pellet_height    = 11.0 * mm
plenum_length    = 2.0  * mm
...
pellet_type = "dished_and_chamfered"
chamfer_start_radius = fuel_ro - 0.4295 * mm
chamfer_height   =  0.16 * mm
dish_radius_curvature = 43.66 * mm
dish_outer_radius = 3.2975 * mm
...
def build_case():
    # %% 1) Geometry and mesh
    rod_mesh = mesh.rod_2d_rz_discrete(
    ...
    rod_mesh.transforms.append(("translate", (0.0, 0.0, 1.485)))
    ...
    D = fields.Displacement(
        ...
        boundaryField=dict(
            ...
            fuelBottom = bc.UnilateralContact(
                value=[0, 0, 0],    
    ...
    # Special command to set all pellet-to-pellet boundaries at once
    D.set_boundary_condition(
        "fuelTop_.*|fuelBottom_.*",
        bc.ImplicitGapContact(
            value=[0, 0, 0],
            penaltyFactor=0.1,
    ...
    case.sliceMapper = offbeat.slice_mapper.ByMaterial()
