...
#include "jumpDiscontinuousCyclicAMIFvPatchFields.H"
...
makePatchFieldTypeNames(jumpDiscontinuousCyclicAMI);

// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

template<>
void Foam::jumpDiscontinuousCyclicAMIFvPatchField<scalar>::updateInterfaceMatrix
(
