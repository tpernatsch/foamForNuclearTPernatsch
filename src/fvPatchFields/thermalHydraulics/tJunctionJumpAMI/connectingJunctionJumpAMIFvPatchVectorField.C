...
#include "connectingJunctionJumpAMIFvPatchVectorField.H"
#include "addToRunTimeSelectionTable.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::connectingJunctionJumpAMIFvPatchVectorField::connectingJunctionJumpAMIFvPatchVectorField
(
    const fvPatch& p,
...
Foam::connectingJunctionJumpAMIFvPatchVectorField::connectingJunctionJumpAMIFvPatchVectorField
(
    const connectingJunctionJumpAMIFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
    ...
    overlapPatchNames_(this->size(),"")
{
    ...
    {
        overlapPatchNames_ = dict.get<wordList>("overlapPatch");
    }
}
...
Foam::tmp<Foam::Field<Foam::vector>> Foam::connectingJunctionJumpAMIFvPatchVectorField::jump() const
{
    if (this->discontinuousCyclicAMIPatch().owner())
    {
        return jump_;
    ...
    {
        const connectingJunctionJumpAMIFvPatchVectorField& nbrPatch =
            refCast<const connectingJunctionJumpAMIFvPatchVectorField>
            (
...
void Foam::connectingJunctionJumpAMIFvPatchVectorField::updateCoeffs()
{
    if(this->discontinuousCyclicAMIPatch().owner())
    {

        // Get patch index from name
        labelList overlapPatchIndeces(overlapPatchNames_.size());

        forAll(overlapPatchNames_, i)
        {
            overlapPatchIndeces[i] = this->patch().boundaryMesh().findPatchID(overlapPatchNames_[i]);
        ...
        scalarField nominator = thisFlux;
        scalarField denominator = restOfFlux + thisFlux + VSMALL;
...
void Foam::connectingJunctionJumpAMIFvPatchVectorField::autoMap
(
...
void Foam::connectingJunctionJumpAMIFvPatchVectorField::rmap
(
...
)
{
    ...
    const connectingJunctionJumpAMIFvPatchVectorField& tiptf =
        refCast<const connectingJunctionJumpAMIFvPatchVectorField>(ptf);
    jump_.rmap(tiptf.jump_, addr);
}


void Foam::connectingJunctionJumpAMIFvPatchVectorField::write(Ostream& os) const
{
    ...
    if(this->discontinuousCyclicAMIPatch().owner())
    {
        ...
        os.writeEntry("overlapPatchName", overlapPatchNames_);
    }
...
void Foam::connectingJunctionJumpAMIFvPatchVectorField::updateInterfaceMatrix
(
...
namespace Foam 
{ 
    makePatchTypeField(fvPatchVectorField, connectingJunctionJumpAMIFvPatchVectorField); 
}
