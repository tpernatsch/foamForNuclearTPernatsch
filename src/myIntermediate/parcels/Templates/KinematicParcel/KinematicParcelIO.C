...
void Foam::KinematicParcel<ParcelType>::readFields(CloudType& c)
{
    ...
    (
        c.newIOobject("nParticlesDecayed", IOobject::MUST_READ),
        readOnProc
    );
    ...
    (
        c.newIOobject("nParcelsDecayed", IOobject::MUST_READ),
        readOnProc
    );
    ...
    (
        c.newIOobject("tTurbLoc", IOobject::MUST_READ),
        readOnProc
    );
...
void Foam::KinematicParcel<ParcelType>::writeFields(const CloudType& c)
{
    ...
    IOField<scalar> nParticlesDecayed
    (
        c.newIOobject("nParticlesDecayed", IOobject::NO_READ),
        np
    );
    IOField<scalar> nParcelsDecayed
    (
        c.newIOobject("nParcelsDecayed", IOobject::NO_READ),
        np
    );
    ...
    IOField<scalar> tTurbLoc(c.newIOobject("tTurbLoc", IOobject::NO_READ), np);
