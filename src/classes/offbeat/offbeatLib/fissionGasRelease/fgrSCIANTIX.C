...
:
    fissionGasRelease(mesh, mat, fgrDict),
    regIOobject
    (
        IOobject
        (
...
#endif             
        false :
        fgrDict_.lookupOrDefault("addToRegistry", false)
...
#endif             
        false :
        fgrDict_.lookupOrDefault("refabricatedRod", false)
    ),
    Gas_produced_
    (
        createOrRead<scalar>
    ...
    #endif             
        1 :
        fgrDict_.lookupOrDefault("nFrequency", 1)
    ),
    relax_
    (       
#ifdef OPENFOAMFOUNDATION
...
#endif             
        1 :
        fgrDict_.lookupOrDefault("relax", 1.0)
    ),
    Q_(nullptr),
    Bu_(nullptr),
    T_(nullptr),
