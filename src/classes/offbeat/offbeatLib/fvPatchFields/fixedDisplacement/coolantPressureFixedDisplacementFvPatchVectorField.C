...
coolantPressureFixedDisplacementFvPatchVectorField::coolantPressureFixedDisplacementFvPatchVectorField
(
    const fvPatch& p,
...
coolantPressureFixedDisplacementFvPatchVectorField::coolantPressureFixedDisplacementFvPatchVectorField
(
    const coolantPressureFixedDisplacementFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
coolantPressureFixedDisplacementFvPatchVectorField::
coolantPressureFixedDisplacementFvPatchVectorField
(
    const coolantPressureFixedDisplacementFvPatchVectorField& ptf,
    const DimensionedField<vector, volMesh>& iF
...
void Foam::coolantPressureFixedDisplacementFvPatchVectorField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void Foam::coolantPressureFixedDisplacementFvPatchVectorField::write(Ostream& os) const
{
