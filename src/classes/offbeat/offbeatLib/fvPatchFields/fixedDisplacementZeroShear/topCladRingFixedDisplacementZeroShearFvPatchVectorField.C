...
#include "topCladRingFixedDisplacementZeroShearFvPatchVectorField.H"
...
topCladRingFixedDisplacementZeroShearFvPatchVectorField::
topCladRingFixedDisplacementZeroShearFvPatchVectorField
(
    const fvPatch& p,
...
:
    coolantPressureFixedDisplacementZeroShearFvPatchVectorField(p, iF),
    topCapRadius_(0.0),
...
topCladRingFixedDisplacementZeroShearFvPatchVectorField
(
    const topCladRingFixedDisplacementZeroShearFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
    const fvPatchFieldMapper& mapper
)
:
    coolantPressureFixedDisplacementZeroShearFvPatchVectorField(ptf, p, iF, mapper),
...
:
    coolantPressureFixedDisplacementZeroShearFvPatchVectorField(p, iF, dict),
...
void topCladRingFixedDisplacementZeroShearFvPatchVectorField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
// Write
void topCladRingFixedDisplacementZeroShearFvPatchVectorField::write(Ostream& os) const
{
    coolantPressureFixedDisplacementZeroShearFvPatchVectorField::write(os);
