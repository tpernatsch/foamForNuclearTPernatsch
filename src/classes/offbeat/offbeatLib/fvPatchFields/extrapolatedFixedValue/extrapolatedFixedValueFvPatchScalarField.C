...
#include "extrapolatedFixedValueFvPatchScalarField.H"
...
extrapolatedFixedValueFvPatchScalarField::extrapolatedFixedValueFvPatchScalarField
(
    const fvPatch& p,
...
extrapolatedFixedValueFvPatchScalarField::extrapolatedFixedValueFvPatchScalarField
(
    const extrapolatedFixedValueFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
:
    ...
    relaxFac_(readScalar(dict.lookup("relax")))
{}


extrapolatedFixedValueFvPatchScalarField::extrapolatedFixedValueFvPatchScalarField
(
    const extrapolatedFixedValueFvPatchScalarField& pivpvf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void extrapolatedFixedValueFvPatchScalarField::updateCoeffs()
{
    if (this->updated())
    {
        return;
    ...
    const word gradFieldName("grad(" + internalField().name() + ")");
...
tmp<Foam::Field<scalar> > extrapolatedFixedValueFvPatchScalarField::snGrad() const
{
    // Name of the gradient field
    const word gradFieldName("grad(" + internalField().name() + ")");
...
tmp<Field<scalar> > extrapolatedFixedValueFvPatchScalarField::
...
void extrapolatedFixedValueFvPatchScalarField::write(Ostream& os) const
{
...
(
    fvPatchScalarField,
    extrapolatedFixedValueFvPatchScalarField
);
