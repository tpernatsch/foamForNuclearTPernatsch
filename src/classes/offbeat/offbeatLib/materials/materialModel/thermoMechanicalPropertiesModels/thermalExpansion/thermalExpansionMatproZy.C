...
#include "thermalExpansionMatproZy.H"
...
namespace Foam
{
    defineTypeNameAndDebug(thermalExpansionMatproZy, 0);
...
Foam::thermalExpansionMatproZy::thermalExpansionMatproZy
(
    const fvMesh& mesh,
...
// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //
void Foam::thermalExpansionMatproZy::correct
(
    symmTensorField& sf, 
    const scalarField& T, 
...
const Foam::symmTensor Foam::thermalExpansionMatproZy::setAlphaT(const scalar& Ti) const 
{
