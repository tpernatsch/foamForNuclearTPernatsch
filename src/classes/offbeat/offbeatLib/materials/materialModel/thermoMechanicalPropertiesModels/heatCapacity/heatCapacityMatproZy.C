...
#include "heatCapacityMatproZy.H"
...
namespace Foam
{
    defineTypeNameAndDebug(heatCapacityMatproZy, 0);
...
Foam::heatCapacityMatproZy::heatCapacityMatproZy
(
    const fvMesh& mesh,
...
// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //
void Foam::heatCapacityMatproZy::correct
(
    scalarField& sf, 
    const scalarField& T, 
