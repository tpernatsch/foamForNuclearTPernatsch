...
void Foam::gapTRISO::correctBuffer()
{
    ...
    word bufferOuterName(gapGasOptDict_.lookupOrDefault<word>("bufferOuterPatches", "bufferOuter"));
    word bufferName(gapGasOptDict_.lookupOrDefault<word>("bufferZones", "Buffer"));
...
Foam::scalar Foam::gapTRISO::ProkschModel()
{
  ...
  word OuterName(gapGasOptDict_.lookupOrDefault<word>("OuterPatch", "outer"));
...
:
    ...
    heatSourceName_(gapGasOptDict.lookupOrDefault<word>("heatSourceName", "Q" )),
    CO_method_(gapGasOptDict.lookupOrDefault<word>("COProductionModel", "Proksch")),
    is3D_(gapGasOptDict.lookupOrDefault<bool>("model3D", false)),
    crackV_(0.0),
    gapOffsetV_(readScalar(gapGasOptDict.lookup("gapVolumeOffset"))),
    reserveV_(readScalar(gapGasOptDict.lookup("gasReserveVolume"))),
    porosity_(readScalar(gapGasOptDict.lookup("bufferPorosity"))),
    crackT_(290),
    reserveT_(290),
    bufferT_(290),
    reserveTlist_(),
    ...
    Mco_(0.0)
{
  ...
  word bufferName(gapGasOptDict_.lookupOrDefault<word>("bufferZones", "Buffer"));
  label bufferID(mesh_.cellZones().findZoneID(bufferName));
  word kernelName(gapGasOptDict_.lookupOrDefault<word>("kernelZones", "Kernel"));
