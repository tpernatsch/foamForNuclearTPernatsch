...
namespace Foam
{
    defineTypeNameAndDebug(TobbeAIM1CreepModel, 0);
...
Foam::TobbeAIM1CreepModel::TobbeAIM1CreepModel
(
    const fvMesh& mesh,
...
void Foam::TobbeAIM1CreepModel::correctCreep
(
