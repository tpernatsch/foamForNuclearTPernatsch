...
namespace Foam
{
    defineTypeNameAndDebug(LimbackCreepModel, 0);
...
Foam::LimbackCreepModel::LimbackCreepModel
(
    const fvMesh& mesh,
...
void Foam::LimbackCreepModel::correctCreep
(
    ...
    {        
        ...
        else
        {
            FatalErrorInFunction
                ...
                << "LimbackCreepModel but not found in registry." << nl
                << abort(FatalError);
        }
