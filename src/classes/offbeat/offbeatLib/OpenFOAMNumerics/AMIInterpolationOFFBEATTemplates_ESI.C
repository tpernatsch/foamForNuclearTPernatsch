...
void Foam::AMIInterpolationOFFBEAT::interpolateToTarget
(
...
{
    addProfiling(ami, "AMIInterpolationOFFBEAT::interpolateToTarget");
...
template<class Type, class CombineOp>
void Foam::AMIInterpolationOFFBEAT::interpolateToSource
(
    const UList<Type>& fld,
    const CombineOp& cop,
    List<Type>& result,
...
{
    addProfiling(ami, "AMIInterpolationOFFBEAT::interpolateToSource");
...
template<class Type, class CombineOp>
Foam::tmp<Foam::Field<Type>> Foam::AMIInterpolationOFFBEAT::interpolateToSource
(
...
template<class Type, class CombineOp>
Foam::tmp<Foam::Field<Type>> Foam::AMIInterpolationOFFBEAT::interpolateToTarget
(
    const Field<Type>& fld,
    const CombineOp& cop,
    const UList<Type>& defaultValues
