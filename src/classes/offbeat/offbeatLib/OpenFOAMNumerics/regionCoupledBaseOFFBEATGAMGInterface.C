...
#include "regionCoupledBaseOFFBEATGAMGInterface.H"
...
Foam::regionCoupledBaseOFFBEATGAMGInterface::regionCoupledBaseOFFBEATGAMGInterface
(
    const label index,
...
:
    ...
    fineregionCoupledOFFBEATLduInterface_
    (
        refCast<const regionCoupledOFFBEATLduInterface>(fineInterface)
    )
{
    ...
    if (fineregionCoupledOFFBEATLduInterface_.owner())
    {
        const polyMesh& nbrMesh =
            fineregionCoupledOFFBEATLduInterface_.nbrMesh();
        ...
        )
        {
            ...
            (
                ...
                (
                    fineregionCoupledOFFBEATLduInterface_.AMI(),
...
Foam::tmp<Foam::labelField> Foam::regionCoupledBaseOFFBEATGAMGInterface::
