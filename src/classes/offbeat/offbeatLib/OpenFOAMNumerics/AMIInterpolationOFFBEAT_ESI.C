...
#include "AMIInterpolationOFFBEAT_ESI.H"
#include "meshTools.H"
...
namespace Foam
{
    defineTypeNameAndDebug(AMIInterpolationOFFBEAT, 0);
    defineRunTimeSelectionTable(AMIInterpolationOFFBEAT, dict);
    defineRunTimeSelectionTable(AMIInterpolationOFFBEAT, component);
}

bool Foam::AMIInterpolationOFFBEAT::cacheIntersections_ = false;


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

Foam::autoPtr<Foam::indexedOctree<Foam::AMIInterpolationOFFBEAT::treeType>>
Foam::AMIInterpolationOFFBEAT::createTree
(
...
Foam::label Foam::AMIInterpolationOFFBEAT::calcDistribution
(
...
void Foam::AMIInterpolationOFFBEAT::projectPointsToSurface
(
    const searchableSurface& surf,
    pointField& pts
) const
{
    addProfiling(ami, "AMIInterpolationOFFBEAT::projectPointsToSurface");
...
void Foam::AMIInterpolationOFFBEAT::normaliseWeights
(
...
{
    addProfiling(ami, "AMIInterpolationOFFBEAT::normaliseWeights");
...
void Foam::AMIInterpolationOFFBEAT::agglomerate
(
...
{
    addProfiling(ami, "AMIInterpolationOFFBEAT::agglomerate");
...
Foam::AMIInterpolationOFFBEAT::AMIInterpolationOFFBEAT
(
...
Foam::AMIInterpolationOFFBEAT::AMIInterpolationOFFBEAT
(
    const AMIInterpolationOFFBEAT& fineAMI,
    const labelList& sourceRestrictAddressing,
    const labelList& targetRestrictAddressing
)
:
...
Foam::AMIInterpolationOFFBEAT::AMIInterpolationOFFBEAT(const AMIInterpolationOFFBEAT& ami)
:
...
bool Foam::AMIInterpolationOFFBEAT::calculate
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch,
...
)
{
    ...
    addProfiling(ami, "AMIInterpolationOFFBEAT::calculate");
    ...
    if (debug)
    {
        Info<< "AMIInterpolationOFFBEAT:" << nl
...
void Foam::AMIInterpolationOFFBEAT::reset
(
...
void Foam::AMIInterpolationOFFBEAT::append
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch
)
{
    addProfiling(ami, "AMIInterpolationOFFBEAT::append");
...
Foam::label Foam::AMIInterpolationOFFBEAT::srcPointFace
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch,
    const vector& n,
...
Foam::label Foam::AMIInterpolationOFFBEAT::tgtPointFace
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch,
    const vector& n,
...
bool Foam::AMIInterpolationOFFBEAT::checkSymmetricWeights(const bool log) const
{
...
void Foam::AMIInterpolationOFFBEAT::writeFaceConnectivity
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch,
...
void Foam::AMIInterpolationOFFBEAT::write(Ostream& os) const
{
