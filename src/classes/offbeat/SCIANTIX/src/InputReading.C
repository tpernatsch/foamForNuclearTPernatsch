...
void InputReading( )
{
  ...
  Sciantix_options[16] = ReadOneSetting("igas_effective_coefficient", input_settings, input_check);
  Sciantix_options[17] = ReadOneSetting("igas_sweeping", input_settings, input_check);
  Sciantix_options[18] = ReadOneSetting("imicro_cracking_span", input_settings, input_check);
