...
#include "GFTractionDisplacementFvPatchVectorField.H"
...
GFTractionDisplacementFvPatchVectorField::
GFTractionDisplacementFvPatchVectorField
(
    const fvPatch& p,
...
GFTractionDisplacementFvPatchVectorField
(
    const GFTractionDisplacementFvPatchVectorField& tdpvf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
void GFTractionDisplacementFvPatchVectorField::autoMap
(
...
void GFTractionDisplacementFvPatchVectorField::rmap
(
...
)
{
    ...
    const GFTractionDisplacementFvPatchVectorField& dmptf =
        refCast<const GFTractionDisplacementFvPatchVectorField>(ptf);
...
void GFTractionDisplacementFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void GFTractionDisplacementFvPatchVectorField::write(Ostream& os) const
{
