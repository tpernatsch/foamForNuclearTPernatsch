...
Foam::word Foam::AMIInterpolationOFFBEAT::interpolationMethodToWord
(
...
typename Foam::AMIInterpolationOFFBEAT::interpolationMethod
Foam::AMIInterpolationOFFBEAT::wordTointerpolationMethod(const word& im)
{
...
Foam::tmp<Foam::scalarField> Foam::AMIInterpolationOFFBEAT::patchMagSf
(
...
void Foam::AMIInterpolationOFFBEAT::sumWeights
(
...
void Foam::AMIInterpolationOFFBEAT::reportSumWeights
(
...
void Foam::AMIInterpolationOFFBEAT::constructFromSurface
(
...
void Foam::AMIInterpolationOFFBEAT::update
(
    const primitivePatch& srcPatch,
    const primitivePatch& tgtPatch,
    const bool report
)
{
    ...
    srcNf_ = (srcPatch.faceNormals());
    tgtNf_ = (tgtPatch.faceNormals());

    srcCf_ = (srcPatch.faceCentres());
    tgtCf_ = (tgtPatch.faceCentres());
...
void Foam::AMIInterpolationOFFBEAT::sumWeights(AMIInterpolationOFFBEAT& AMI)
{
...
void Foam::AMIInterpolationOFFBEAT::sumWeights(PtrList<AMIInterpolationOFFBEAT>& AMIs)
{
...
void Foam::AMIInterpolationOFFBEAT::reportSumWeights(AMIInterpolationOFFBEAT& AMI)
{
    reportSumWeights
    (
        AMI.srcMagSf_,
...
void Foam::AMIInterpolationOFFBEAT::normaliseWeights(AMIInterpolationOFFBEAT& AMI)
{
...
void Foam::AMIInterpolationOFFBEAT::normaliseWeights(UPtrList<AMIInterpolationOFFBEAT>& AMIs)
{
    UPtrList<scalarListList> srcWeights(AMIs.size());
    forAll(AMIs, i)
    {
