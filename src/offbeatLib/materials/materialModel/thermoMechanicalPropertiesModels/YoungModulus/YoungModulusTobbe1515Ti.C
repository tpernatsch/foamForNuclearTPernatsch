...
#include "YoungModulusTobbe1515Ti.H"
...
namespace Foam
{
    defineTypeNameAndDebug(YoungModulusTobbe1515Ti, 0);
    addToRunTimeSelectionTable
    (
        YoungModulusModel, 
        YoungModulusTobbe1515Ti, 
        dictionary
    );
}
...
Foam::YoungModulusTobbe1515Ti::YoungModulusTobbe1515Ti
(
    const fvMesh& mesh,
    ...
    par2(81.67e-3)
{
    ...
    if((dict.found("YoungModulus")) || (dict.dictName() == "YoungModulus"))
    {
        ...
        par1 = YoungModulusDict.lookupOrDefault<scalar>("par1", 202.7);        
        par2 = YoungModulusDict.lookupOrDefault<scalar>("par2", 81.67e-3);
    }
...
// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //
void Foam::YoungModulusTobbe1515Ti::correct
(
    scalarField& sf, 
    const scalarField& T, 
...
{ 
    ...
    {   
        ...
        {
            WarningInFunction
                << "Foam::YoungModulusTobbe1515Ti::correct() :\n"
        ...
        const scalar nominalValue = (par1-par2*Ti)*1e9;
