...
#include "constantPoissonRatioZircaloy.H"
...
namespace Foam
{
    defineTypeNameAndDebug(constantPoissonRatioZircaloy, 0);
    addToRunTimeSelectionTable
    (
        PoissonRatioModel, 
        constantPoissonRatioZircaloy, 
        dictionary
    );
}
...
Foam::constantPoissonRatioZircaloy::constantPoissonRatioZircaloy
(
    const fvMesh& mesh,
...
// * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * * //
void Foam::constantPoissonRatioZircaloy::correct
(
    scalarField& sf, 
    const scalarField& T, 
