...
namespace Foam
{
    ...
    const char* swellingParfumeBuffer::group_ = 
        ("behavioralModels::swelling::BufferParfume");

    defineParameter(swellingParfumeBuffer, F_epsilonSwelling_, 
        "F_epsilonSwelling", (dimless), 1.0);
        
    defineParameter(swellingParfumeBuffer, delta_epsilonSwelling_, 
    ...
    fcf_(dict.lookupOrDefault("fluxConversionFactor", 1.0))
{
    ...
    method_ = interpolateTableBase::LINEAR;
    obMethod_ex_ = interpolateTableBase::EXTRAPOLATION;
    obMethod_fix_ = interpolateTableBase::FIXED;
