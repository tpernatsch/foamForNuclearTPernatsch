...
namespace Foam
{
    ...
    const char* swellingGrowthGeneralized1515Ti::group_ = 
        ("behavioralModels::swelling::Steel1515TiGeneralized");

    defineParameter(swellingGrowthGeneralized1515Ti, F_epsilonSwelling_, 
        "F_epsilonSwelling", (dimless), 1.0);
        
    defineParameter(swellingGrowthGeneralized1515Ti, delta_epsilonSwelling_, 
