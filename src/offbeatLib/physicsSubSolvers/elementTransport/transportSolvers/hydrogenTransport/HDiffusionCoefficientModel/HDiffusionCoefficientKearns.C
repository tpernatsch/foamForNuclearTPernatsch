...
#include "HDiffusionCoefficientKearns.H"
...
namespace Foam
{
    defineTypeNameAndDebug(HDiffusionCoefficientKearns, 0);
    addToRunTimeSelectionTable
    (
        HDiffusionCoefficientModel, 
        HDiffusionCoefficientKearns, 
        dictionary
    );
}
...
Foam::HDiffusionCoefficientKearns::HDiffusionCoefficientKearns
(
    const fvMesh& mesh,
    const materials& mat,
...
void Foam::HDiffusionCoefficientKearns::correctDH
(
...
)
{
    ...
    const scalar D0 = 7.9e-7;
    const scalar Ed = 4.49e4;
