...
#include "HDiffusionCoefficientBison.H"
...
namespace Foam
{
    defineTypeNameAndDebug(HDiffusionCoefficientBison, 0);
    addToRunTimeSelectionTable
    (
        HDiffusionCoefficientModel, 
        HDiffusionCoefficientBison, 
        dictionary
    );
}
...
Foam::HDiffusionCoefficientBison::HDiffusionCoefficientBison
(
    const fvMesh& mesh,
    const materials& mat,
...
void Foam::HDiffusionCoefficientBison::correctDH
(
...
)
{
    ...
    const scalar D0 = 1.08e-6;
    const scalar Ed = 4.4e4;
