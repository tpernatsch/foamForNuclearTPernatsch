...
namespace Foam
{
    defineTypeNameAndDebug(TSSdMCMINN, 0);
...
void Foam::TSSdMCMINN::correctTSSd
(
...
)
{
    ...
    const scalar TSSd0 = 1.06e5;
    const scalar Qd = 35990;
