...
namespace Foam
{
    defineTypeNameAndDebug(TSSdUneZr2, 0);
...
void Foam::TSSdUneZr2::correctTSSd
(
...
)
{
    ...
    const scalar TSSd0 = 1.43e5;
    const scalar Qd = 36686;
