...
namespace Foam
{
    defineTypeNameAndDebug(TSSdBison, 0);
...
void Foam::TSSdBison::correctTSSd
(
...
)
{
    ...
    const scalar e = 1.6022e-19;
    const scalar Na = 6.0221e23; 

    const scalar TSSd0 = 1.02e5;
    const scalar Qd = 0.37 * e * Na;
