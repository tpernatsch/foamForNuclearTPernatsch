...
namespace Foam
{
    defineTypeNameAndDebug(TSSdUneZrLiner, 0);
...
Foam::TSSdUneZrLiner::TSSdUneZrLiner
(
    const fvMesh& mesh,
    const materials& mat,
...
void Foam::TSSdUneZrLiner::correctTSSd
(
...
)
{
    ...
    const scalar TSSd0 = 1.41e5;
    const scalar Qd = 38104;
