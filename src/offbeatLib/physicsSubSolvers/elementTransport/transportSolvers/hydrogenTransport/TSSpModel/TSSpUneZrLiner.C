...
namespace Foam
{
    defineTypeNameAndDebug(TSSpUneZrLiner, 0);
...
Foam::TSSpUneZrLiner::TSSpUneZrLiner
(
    const fvMesh& mesh,
    const materials& mat,
...
void Foam::TSSpUneZrLiner::correctTSSp
(
...
)
{
    ...
    const scalar TSSp0 = 3.39e4;
    const scalar Qp = 27291;
