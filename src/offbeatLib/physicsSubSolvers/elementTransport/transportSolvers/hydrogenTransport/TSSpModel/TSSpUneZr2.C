...
namespace Foam
{
    defineTypeNameAndDebug(TSSpUneZr2, 0);
...
void Foam::TSSpUneZr2::correctTSSp
(
...
)
{
    ...
    const scalar TSSp0 = 3.27e4;
    const scalar Qp = 25042;
