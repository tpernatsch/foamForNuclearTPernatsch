...
namespace Foam
{
    defineTypeNameAndDebug(TSSpMerlinoExp, 0);
...
Foam::TSSpMerlinoExp::TSSpMerlinoExp
(
    const fvMesh& mesh,
    const materials& mat,
...
void Foam::TSSpMerlinoExp::correctTSSp
(
...
)
{
    ...
    const scalar TSSp0 = 1.74e5;
    const scalar Qp = 3.64e4;
