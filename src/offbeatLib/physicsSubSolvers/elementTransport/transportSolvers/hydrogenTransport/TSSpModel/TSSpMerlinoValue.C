...
namespace Foam
{
    defineTypeNameAndDebug(TSSpMerlinoValue, 0);
...
Foam::TSSpMerlinoValue::TSSpMerlinoValue
(
    const fvMesh& mesh,
    const materials& mat,
...
void Foam::TSSpMerlinoValue::correctTSSp
(
