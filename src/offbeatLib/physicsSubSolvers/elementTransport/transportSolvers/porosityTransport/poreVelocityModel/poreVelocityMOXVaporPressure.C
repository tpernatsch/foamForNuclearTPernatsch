...
:
    ...
    CPuO2_(5.396e-8),
    CUO2_(5.4704e-8),
    wPu_(readScalar(dict.subDict("isotopes").subDict("Pu").lookup("ratioOverMetal"))),
    wU_(readScalar(dict.subDict("isotopes").subDict("U").lookup("ratioOverMetal"))),
    wAm_
    (
        (dict.subDict("isotopes").found("Am"))
        ? readScalar(dict.subDict("isotopes").subDict("Am").lookup("ratioOverMetal"))
        : 0.0
    ),
