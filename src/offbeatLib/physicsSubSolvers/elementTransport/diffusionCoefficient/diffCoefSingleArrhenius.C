...
#include "diffCoefSingleArrhenius.H"
#include "addToRunTimeSelectionTable.H"

namespace Foam
{
    defineTypeNameAndDebug(diffCoefSingleArrhenius, 0);
    addToRunTimeSelectionTable(diffCoefModel, diffCoefSingleArrhenius, dictionary);
...
Foam::diffCoefSingleArrhenius::diffCoefSingleArrhenius
(
    const fvMesh& mesh,
...
void Foam::diffCoefSingleArrhenius::updateCoef
(
    volScalarField& sf,
...
)
{
    forAll(addr, i)
    {
        ...
        sf[cellI] = d1_*exp(-q1_/R/T[cellI]);
