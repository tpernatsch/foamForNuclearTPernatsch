...
void Foam::cellZoneMultiMaterialInterface::correct()
{
    ...
    
    {
        ...
        forAll(wEps_i, faceI)
        {
            ...
            {
                wEps_i[faceI] = interfaceWeight_;
                wGrad_i[faceI] = interfaceWeight_;
            }
        }
    }
    ...
    forAll(weightsEps_.boundaryField(), patchI)
    {
        ...
        if(pfEps.coupled())
        {
            const lduInterface& p = refCast<const lduInterface>(pfEps.patch());
            ...
            forAll(pfEps, faceI)
            {
                ...
                {
                    pfEps[faceI] = interfaceWeight_;
                    pfGrad[faceI] = interfaceWeight_;
                }
            }
        }
    }
