...
#include "codedFixedGradientFvPatchField.H"
...
template<class Type>
const Foam::word Foam::codedFixedGradientFvPatchField<Type>::codeTemplateC
    = "fixedValueFvPatchFieldTemplate.C";

template<class Type>
const Foam::word Foam::codedFixedGradientFvPatchField<Type>::codeTemplateH
...
template<class Type>
void Foam::codedFixedGradientFvPatchField<Type>::setFieldTemplates
(
    dynamicCode& dynCode
)
{
...
template<class Type>
const Foam::IOdictionary& Foam::codedFixedGradientFvPatchField<Type>::dict() const
{
...
template<class Type>
Foam::dlLibraryTable& Foam::codedFixedGradientFvPatchField<Type>::libs() const
{
...
template<class Type>
void Foam::codedFixedGradientFvPatchField<Type>::prepare
(
    dynamicCode& dynCode,
...
template<class Type>
const Foam::dictionary& Foam::codedFixedGradientFvPatchField<Type>::codeDict()
const
{
...
template<class Type>
Foam::string Foam::codedFixedGradientFvPatchField<Type>::description() const
{
    return
        "patch "
      + this->patch().name()
...
template<class Type>
void Foam::codedFixedGradientFvPatchField<Type>::clearRedirect() const
{
...
template<class Type>
Foam::codedFixedGradientFvPatchField<Type>::codedFixedGradientFvPatchField
(
    const fvPatch& p,
...
Foam::codedFixedGradientFvPatchField<Type>::codedFixedGradientFvPatchField
(
    const codedFixedGradientFvPatchField<Type>& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
Foam::codedFixedGradientFvPatchField<Type>::redirectPatchField() const
{
...
template<class Type>
void Foam::codedFixedGradientFvPatchField<Type>::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
template<class Type>
void Foam::codedFixedGradientFvPatchField<Type>::evaluate
(
...
)
{
    ...
    fixedGradientFvPatchField<Type>::evaluate(commsType);
}


template<class Type>
void Foam::codedFixedGradientFvPatchField<Type>::write(Ostream& os) const
{
