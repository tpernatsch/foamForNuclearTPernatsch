    ...
    g_(9.80665)
{
    ...
    (
        dict.found("qCHF") 
        and 
        correlations_.get<word>("CHF") == "Bessiron"
    )
    {
    ...
    if (correlations_.get<word>("CHF") == "lookuptableGroeneveld")
    {
    ...
    if (enthalpyModel_ == true || correlations_.get<word>("CHF") == "EPRI")
    {
...
void coolantChannelfvPatchScalarField::updateCoeffs()
{
    ...
    forAll(zetas, i)
    {
        ...
        if (correlations_.get<word>("SinglePhase") == "analyticalLaminar")
        {
        ...
        else if (correlations_.get<word>("SinglePhase") == "Gnielinski")
        {
        ...
        else if (correlations_.get<word>("SinglePhase") == "TRACETubeNC")
        {
        ...
        else if (correlations_.get<word>("SinglePhase") == "TRACERodBundleNC")
        {
        ...
        else if (correlations_.get<word>("SinglePhase") == "DittusBoelter")
        {
        ...
        if (correlations_.get<word>("SubcooledBoiling") == "Chen")
        {
            scalar F(1.0);
        ...
        else if (correlations_.get<word>("SubcooledBoiling") == "JensLottes")
        {
        ...
        else if (correlations_.get<word>("SubcooledBoiling") == "Thom")
        {
        ...
        else if (correlations_.get<word>("SubcooledBoiling") == "Rohsenow")
        {
        ...
        // Chen's correlation (1963)
        if (correlations_.get<word>("SaturatedBoiling") == "Chen")
        {
            scalar tempQ(0.0);
            if (Q_[i] < 0.0)
            {
        ...
        else if (correlations_.get<word>("SaturatedBoiling") == "SchrockGrossman")
        {
            scalar tempQ(0.0);
            if (Q_[i] < 0.0)
            {
        ...
        // Rohsenow correlation (1952)
        else if (correlations_.get<word>("SaturatedBoiling") == "Rohsenow")
        {
        ...
        if ((correlations_.get<word>("FilmBoiling") == "GroeneveldAnnular") || 
            (correlations_.get<word>("FilmBoiling") == "GroeneveldTubular"))
        {
            scalar tempQ(0.0);
            if (Q_[i] < 0.0)
            {
            ...
            else if (correlations_.get<word>("FilmBoiling") == "GroeneveldTubular")
            {
                GrA = 0.00109;
                GrB = 0.989;
                GrC = 1.41;
        ...
        else if (correlations_.get<word>("FilmBoiling") == "BishopSandbergTong")
        {
        ...
        else if (correlations_.get<word>("FilmBoiling") == "Frederking")
        {
        ...
        else if (correlations_.get<word>("FilmBoiling") == "Sakurai")
        {
            scalar Tvap(0.5 * (Twall_[i] + IF97::Tsat97(coolantPressure_[i])));
    ...
    if (correlations_.get<word>("ONB") == "Basu")
    {
        forAll(zetas, i)
        {
    ...
    else if (correlations_.get<word>("ONB") == "BerglesRohsenow")
    {
        scalar oldValue(0.0);
        scalar fx(0.0);
        scalar dfx(0.0);
    ...
    else if (correlations_.get<word>("ONB") == "Bessiron")
    {
        forAll(zetas, i)
        {
    ...
    if (correlations_.get<word>("CHF") == "EPRI")
    {
    ...
    else if (correlations_.get<word>("CHF") == "lookuptableGroeneveld")
    {
        forAll(zetas, i)
        {
    ...
    else if (correlations_.get<word>("CHF") == "Zuber")
    {
        forAll(zetas, i)
        {
    ...
    else if (correlations_.get<word>("CHF") == "ModifiedZuber")
    {
        forAll(zetas, i)
        {
            scalar fsubc(1.0 + 0.1 * pow(IF97::rholiq_p(coolantPressure_[i]) / 
    ...
    else if (correlations_.get<word>("CHF") == "GE")
    {
        forAll(zetas, i)
        {
    ...
    // Bessiron correlation for NSRR RIA transients (stagnant flow, normal temperature and pressure)
    // (V. Bessiron, Modelling of Clad-to-Coolant Heat Transfer for RIA Applications, 2007) 
    else if (correlations_.get<word>("CHF") == "Bessiron")
    {
        forAll(zetas, i)
        {
    ...
    forAll(zetas, i)
    {
        ...
        if (correlations_.get<word>("TransitionBoiling") == "McDonoughMilichKing")
        {
        ...
        else if (correlations_.get<word>("TransitionBoiling") == "Bessiron")
        {
        ...
        else if (correlations_.get<word>("TransitionBoiling") == "None")
        {
            hTB[i] = hFB[i];
        }
        else
    ...
    forAll(zetas, i)
    {
        ...
        if (correlations_.get<word>("Leidenfrost") == "GroeneveldStewartCorrected")
        {
        ...
        else if (correlations_.get<word>("Leidenfrost") == "GroeneveldStewart")
        {
            TLeidenfrost[i] = 557.85 + 44.1 * coolantPressure_[i] / 1000000.0 -
                3.72 * pow(coolantPressure_[i] / 1000000.0, 2.0);
        ...
        else if (correlations_.get<word>("Leidenfrost") == "Ohnishi")
        {
        ...
        else if (correlations_.get<word>("Leidenfrost") == "Gotovskij")
        {
        ...
        else if (correlations_.get<word>("Leidenfrost") == "Zuber")
        {
        ...
        // Bessiron correlation for RIA transients (2007)
        else if (correlations_.get<word>("Leidenfrost") == "Bessiron")
        {
    ...
    forAll(zetas, i)
    {
        if (correlations_.get<word>("ONB") == "Bessiron" && correlationRegimeList_[i] == "saturatedBoiling" &&
    ...
    forAll(zetas, i)
    {
        ...
        // Saturated boiling
            ...
            (correlations_.get<word>("CHF") == "Bessiron" && vaporizedThickness_[i] >= 0.0 && 
            vaporizedThickness_[i] < thicknessBessironRIA_))
        {
            if (correlations_.get<word>("CHF") == "Bessiron" && 
        ...
        {
            // RIA post-CHF
            if (correlations_.get<word>("CHF") == "Bessiron" && heatFlux_[i] > qLeidenfrost[i])
            {
                h_[i] = hTB[i];
    ...
    if (correlations_.get<word>("ONB") == "Bessiron" && correlations_.get<word>("CHF") == "Bessiron")
    {
...
void coolantChannelfvPatchScalarField::write(Ostream& os) const
{
    ...
    correlationRegimeList_.writeEntry("correlationRegimeList", os);
