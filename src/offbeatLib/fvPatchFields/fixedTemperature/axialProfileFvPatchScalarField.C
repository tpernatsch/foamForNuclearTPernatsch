...
#include "axialProfileFvPatchScalarField.H"
...
:
    ...
    table_(zValues_, profileData_, zMethod_),
    zRef_(),
    dict_()
{}
...
:
    ...
    profileData_(dict.subDict("axialProfileDict").lookup("data")),
...
axialProfileFvPatchScalarField
(
    const axialProfileFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::axialProfileFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::axialProfileFvPatchScalarField::write(Ostream& os) const
{
