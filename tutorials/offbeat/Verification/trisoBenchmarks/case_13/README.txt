...
{
    timePoints  (0.0    1e9);
    vhgr        (2487393346 2487393346);
    // fission_rate * energy_per_fission
    // = 7.773104207e19 f/m³/s * 3.2e-11 J/f
    materials ( Kernel );
}
...
{
    timePoints  ( 0     1e9);
    //- Derived by 5.3e25 n/m2 of 359 days
    fastFlux    (1.708707315e14  1.708707315e14); // n/cm2/s
  ...
  Buffer
  {
    ...
    "IPyC|OPyC"
    {
      ...
      rheologyModelOptions
      {
          ...
          relax 1;
          creepModel constantPrincipalStress;
