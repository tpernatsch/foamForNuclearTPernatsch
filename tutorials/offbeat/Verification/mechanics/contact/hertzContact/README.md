...
The analytical solution for the contact width \(b\), maximum contact pressure \(P_{max}\) and stress distribution in
the y-/vertical direction \(\sigma_{yy}(y)\) from [^1] are
...
The comparison between the OFFBEAT solution and the analytical solution is shown in the figure 
below.
