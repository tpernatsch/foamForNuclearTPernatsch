...
mp4_filepath = os.path.join(output_directory, "animation.mp4")
input_pattern = os.path.join(frames_folder, "animation.%04d.png")
...
ffmpeg_command = (
    f"ffmpeg -framerate 10 -i {input_pattern} "
