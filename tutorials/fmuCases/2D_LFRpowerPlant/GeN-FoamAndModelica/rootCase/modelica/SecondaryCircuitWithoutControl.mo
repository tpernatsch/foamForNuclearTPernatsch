model SecondaryCircuitWithoutControl
  ...
  Modelica.Blocks.Interfaces.RealInput valveControlInput(start=0) annotation(
    Placement(visible = true, transformation(origin = {70, 150}, extent = {{10, -10}, {-10, 10}}, rotation = 0), iconTransformation(origin = {-140, 158}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput frequencyOutput(start = 50) annotation(
    Placement(visible = true, transformation(origin = {120, 150}, extent = {{10, -10}, {-10, 10}}, rotation = 0), iconTransformation(origin = {146, 76}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealOutput electricalPowerOutput(start = 722) annotation(
    Placement(visible = true, transformation(origin = {250, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-110, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(valveVapAdmissionTurb.theta, limiter.y) annotation(
    Line(points = {{-90, 84}, {-90, 170}, {-21, 170}}, color = {0, 0, 127}));
  connect(add.y, limiter.u) annotation(
    Line(points = {{19, 170}, {2, 170}}, color = {0, 0, 127}));
  connect(add.u2, valveControlInput) annotation(
    Line(points = {{42, 164}, {42, 150}, {70, 150}}, color = {0, 0, 127}));
  connect(defaultValve.y, add.u1) annotation(
    Line(points = {{59, 190}, {42, 190}, {42, 176}}, color = {0, 0, 127}));
  connect(electricalPowerOutput, powerSensorElectric.P) annotation(
    Line(points = {{250, -50}, {200, -50}}, color = {0, 0, 127}));
  annotation(
    uses(ThermoPower(version = "3.1"), Modelica(version = "3.2.3")),
    Diagram(coordinateSystem(extent = {{-280, 220}, {260, -200}}), graphics = {Rectangle(origin = {75, 180}, lineColor = {114, 159, 207}, fillColor = {255, 255, 255}, lineThickness = 1, extent = {{-105, 40}, {105, -40}}), Text(origin = {150, 210}, extent = {{-30, 10}, {30, -10}}, textString = "Turbine-admission
Controller")}),
...
Circuit")}),
    version = "");
end SecondaryCircuitWithoutControl;