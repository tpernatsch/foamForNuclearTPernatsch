...
# Create figures
fig1, axes1 = plt.subplots(nrows=2, ncols=2, sharex=True)
fig2, axes2 = plt.subplots(nrows=2, ncols=3, sharex=True) # figsize=(8, 4))
...
fig1.savefig("results_allplot_fmus1.png")
fig2.savefig("results_allplot_fmus2.png")
