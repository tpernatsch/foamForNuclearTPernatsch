...
GeN-Foam is a multi-physics solver for reactor analysis based on OpenFOAM \cite 2021OpenFOAM \cite Weller1998 (ESI/OpenCFD distribution from [www.openfoam.com](https://www.openfoam.com), currently v2106). It can solve (coupled or alternatively) for:
