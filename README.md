...
GeN-Foam is a multi-physics solver for reactor analysis based on OpenFOAM \cite 2021OpenFOAM \cite Weller1998 (ESI distribution from (www.openfoam.com)[www.openfoam.com] ! currently 2106). It can solve (coupled or alternatively) for:
