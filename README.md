...
GeN-Foam is a multi-physics solver for reactor analysis based. It can solve (coupled or alternatively) for:
...
The current version of GeN-Foam is based on OpenFOAM, ESI/OpenCFD distribution, currently v2306, available at [www.openfoam.com](https://www.openfoam.com).
