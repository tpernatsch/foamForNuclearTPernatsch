...
The Young modulus defines the elastic stiffness of a material. It is a key
mechanical property used by the mechanical solver in OFFBEAT and by the
thermo-mechanics module used in multi-physics GeN-Foam simulations.

The Young modulus model is defined in the ``materials`` subdictionary of
``solverDict``.
...
For materials with constant properties, the Young modulus may be specified
...
The thermo-mechanics module currently provides the following Young modulus
models:
