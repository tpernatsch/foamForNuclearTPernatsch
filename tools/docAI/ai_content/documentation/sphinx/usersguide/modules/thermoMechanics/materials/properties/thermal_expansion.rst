...
of temperature. It is a key thermo-mechanical property used in OFFBEAT
and in the thermo-mechanics module within multi-physics GeN-Foam
simulations.

The thermal expansion model is defined inside the ``materials``
subdictionary of ``solverDict``.
