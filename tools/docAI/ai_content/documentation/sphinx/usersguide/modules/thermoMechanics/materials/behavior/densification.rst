...
This phenomenon is particularly relevant for oxide fuels. In these fuels,
the as-fabricated porosity decreases as irradiation progresses. As a result,
the fuel volume reduces, and the densification contributes a corresponding
strain.

In OFFBEAT and in the thermo-mechanics module used within multi-physics
GeN-Foam simulations, densification models are defined inside the material
