...
structured meshes in these configurations.
...
mesh generation. Users are strongly encouraged to become familiar with OpenFOAM
...
* **Edges**:
  ...
  two-dimensional smeared-column simulations, but it can be used to represent curved pellet
...
it can also be applied to other coupled surfaces, such as pellet–pellet contact.
