...
A time-dependent hydrogen distribution in a precharged Zircaloy-2 specimen under a fixed temperature gradient, based on Sawatzky.[^1]

The case considered is a 25.4 mm long rectangular specimen, initially charged with 64 ppm hydrogen. It is then annealed for 41 days under a constant temperature gradient. The cold and hot end temperatures are 157&deg;C and 454&deg;C, respectively.
