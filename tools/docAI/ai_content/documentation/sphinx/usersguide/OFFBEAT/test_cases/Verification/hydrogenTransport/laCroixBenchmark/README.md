...
Experimental studies by La Croix [^1] investigated the behavior of hydrogen in a cold-worked, stress-relieved Zircaloy-4 sheet subjected to repeated heating and cooling cycles. The sample is initially charged with 254 wt.ppm of hydrogen.
...
<figcaption>Temperature history for the experiment of La Croix</figcaption>
</figure></div>

<div style="text-align: center;"><figure>
<img src="Css.png" alt="run test to generate figure" width="50%">
<figcaption>Hydrogen concentration history for the experiment of La Croix</figcaption>
</figure></div>
