This is a Doxygen-generated documentation for the GeN-Foam multi-physics application. 
Beside the usual Doxygen documentation of the source code, it provides a basic user guide, including:
*  [Introduction to GeN-Foam - README file](@ref README)
*  [GeN-Foam Theory](@ref THEORY)
