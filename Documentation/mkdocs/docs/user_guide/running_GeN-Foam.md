...
At the end of the simulation, one can reconstruct and merge the results using the standard OpenFOAM:
...
More details on post-processing [page](./post_processing.md).
