...
More information in [this page](./porousMedium.md).
...
More information in [this page](./thermalAndTurbulenceProperties.md).


## Setting Case

Initial and boundary conditions are detailed in [this page](./settingCase.md).