...
- *scalarTransportFoam* passive scalar transport equation solver. This standard solver has been transposed from OpenFOAM ([link](https://www.openfoam.com/documentation/guides/latest/man/scalarTransportFoam.html)) into the new GeN-Foam solver structure (see [*src/classes/openFoamImportedSolvers/scalarTransportFoam*](../classes/openFoamImportedSolvers/scalarTransportFoam/scalarTransportFoam.md)).