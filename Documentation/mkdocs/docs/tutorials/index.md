...
*1D_thermalMSR_pointKinetics*  is the same as 1D_MSR_pointKinetics, but for a thermal MSR. This implies that there is a graphite structure in the core. The objective is to show: how to use the lumpedParameterStructure power model; and how to set a power density both in the salt and in the graphite.
