model test
  ...
  Modelica.Blocks.Interfaces.RealOutput temperatureSourceCoupled annotation(
    Placement(visible = true, transformation(origin = {36, 52}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {50, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(ramp1.y, temperatureSourceCoupled) annotation(
    Line(points = {{-22, 56}, {36, 56}, {36, 52}}, color = {0, 0, 127}));
