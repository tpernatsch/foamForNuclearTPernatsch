...
Because of the complexity of the fuel-behaviour solver, this exercise is very short and is not meant to explain all the nuances of the solver, but rather to illustrate its logic and its main dictionary, i.e. constant/fluidBehaviourRegion/solverDict
