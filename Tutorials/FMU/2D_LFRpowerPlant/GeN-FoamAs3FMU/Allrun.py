...
# Set variables for PIDs
PIDsFMU.set("measFrequency", np.float64(50))
...
listOfVariablesSecCir = getListVars("SecondaryCircuitWithoutControl_1_result.txt")
listOfVariablesPIDs = getListVars("pidControllers_2_result.txt")
...
resultsPIDs = pd.DataFrame()
for var in listOfVariablesPIDs:
    resultsPIDs[var] = res[PIDsFMU][var]
resultsPIDs.to_csv("Reactor/pidControllers.csv", index=False)

print("End Reactor/pidControllers.csv writting")
